...
// ========================== Produkt ROUTE ====================================
    productsRoute.route('/')
        ...
        .post(function(req, res) {                                              // Ein Produkt erstellen (Zugriff: POST http://localhost:8080/products)
        ...
        .get(function(req, res) {                                               // Alle Produkte (Zugriff: GET http://localhost:8080/products)
...
// -----------------------------------------------------------------------------
    productsRoute.route('/:product_id')
        ...
        .get(function(req, res) {                                               // Produkt mit der ID (Zugriff GET http://localhost:8080/products/:product_id)
        ...
        .put(function(req, res) {                                               // Aktualliesieren (Zugriff PUT http://localhost:8080/products/:product_id)
            var responseText = "";
            Product.findById(req.params.product_id, function(err, product) {
        ...
        .delete(function(req, res) {                                            // Das Produkt nach der ID gelöscht (Zugriff DELETE http://localhost:8080/products/:product_id)
